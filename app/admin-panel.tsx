    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            style={styles.managementButton}
            onPress={() => router.push('/admin-activation-codes' as any)}
            activeOpacity={0.8}
          >
            <View style={styles.managementButtonContent}>
              <List size={24} color="#10b981" />
              <View style={styles.managementButtonText}>
                <Text style={styles.managementButtonTitle}>View All Activation Codes</Text>
                <Text style={styles.managementButtonSubtitle}>Manage codes, view master accounts and subscriptions</Text>
              </View>
            </View>
          </TouchableOpacity>
